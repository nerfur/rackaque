...
-- Test Rows (not fully supported in this release - so we add one hidden row per room)
...
-- A couple of devices for racks numbered from top, includes primary_mac and install_build fields (not exposed in GUI in RackMonkey 1.2.5)
